...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public static var mewheniseemagnus_X = 90;
	public static var mewheniseemagnus_Y = 430;
		...
		if(!dialogueEnded) {
			...
			if(PlayerSettings.player1.controls.ACCEPT) {
				if(!daText.finishedText) {
					...
					daText = new Alphabet(mewheniseemagnus_X, mewheniseemagnus_Y, textToType, false, true, 0.0, 0.7);
					add(daText);
	...
	function startNextDialog():Void
	{
		...
		daText = new Alphabet(mewheniseemagnus_X, mewheniseemagnus_Y, textToType, false, true, curDialogue.speed, 0.7);
		add(daText);
