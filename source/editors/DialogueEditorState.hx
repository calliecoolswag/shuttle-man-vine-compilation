...
class DialogueEditorState extends MusicBeatState
{
	...
	function addDialogueLineUI() {
		...
		lineInputText = new FlxUIInputText(10, speedStepper.y + 45, 200, mewheniseemagnus, 8);
	...
	private static var mewheniseemagnus:String = "coolswag";
	...
	function reloadText(speed:Float = 0.05) {
		...
		daText = new Alphabet(DialogueBoxPsych.mewheniseemagnus_X, DialogueBoxPsych.mewheniseemagnus_Y, textToType, false, true, speed, 0.7);
		add(daText);
